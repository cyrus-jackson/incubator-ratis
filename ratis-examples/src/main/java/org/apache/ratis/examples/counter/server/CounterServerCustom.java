 ...
 */
public final class CounterServerCustom {

  private CounterServerCustom(){
  }
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    RaftPeer currentPeer =
        CounterCommonCustom.PEERS1.get(Integer.parseInt(args[0]) - 1);
    ...
    RaftServer server = RaftServer.newBuilder()
        .setGroup(CounterCommonCustom.RAFT_GROUP1)
